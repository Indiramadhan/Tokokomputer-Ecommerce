                                    ...
                                    foreach ($cart as $item) { ?>
                                        <tr>
                                            ...
                                            <td width="375px">
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                        <img src="<?= base_url() ?>/assets/img/gambar/<?= $item->gambar1; ?>" width="75px" height="75px" alt="">
                                                    </div>
                                                    <div class="col-sm-10">
                                                        <h6><?= $item->nick; ?></h6>
                                                        <div><?= $item->nama_ktg; ?></div>
                                                        <p>Jumlah : <?= $item->quantity; ?></p>
                                                        <input type="hidden" name="idcart[]" value="<?php echo $item->id ?>">
                                                        <input type="hidden" name="idbrg[]" value="<?php echo $item->id_brg ?>">
                                            ...
                                            <td width="125px">
                                                Rp <?php
                                                    $angka_format = number_format($item->harga_jual * $item->quantity);
                                                    echo $angka_format;
                                                    ?> ;-
                                            </td>
                                        </tr>
